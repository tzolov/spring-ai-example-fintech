...
public class Application implements CommandLineRunner {
	...
	List<String> questions = List.of(
			"What is the revenue of {company} in 2021? Answer in millions, with page reference",
			"What customer segments grew the fastest for {company} in 2021?",
			"What geographies grew the fastest for {company} in 2021?",
			"How {company} performed in the different geographies in 2021?",
			// "What was the COVID-19 impact on {company}'s business between 2021 and 2021?",
			"What is the revenue growth of {company} from 2020 to 2021?");
